...
public class DatabaseAdapter extends SQLiteOpenHelper
{
    ...
    private static String startdest;
    ...
    public ArrayList<HashMap<String, String>> getTimeTable()
    {
        ...
        HashMap localHashMap1 = new HashMap();
        localHashMap1.put("1", Base.trainLine);
        localHashMap1.put("2", Base.Sourcevaltxt);
        localHashMap1.put("3", Base.Destinationvaltxt);
        localHashMap1.put("4", "");
        localHashMap1.put("5", "");
        localHashMap1.put("6", "");
        localArrayList.add(localHashMap1);
        HashMap localHashMap2 = new HashMap();
        localHashMap2.put("1", "Train");
        localHashMap2.put("2", "Departs");
        localHashMap2.put("3", "Arrives");
        localHashMap2.put("4", "");
        localHashMap2.put("5", "Cars");
        localHashMap2.put("6", "");
        localArrayList.add(localHashMap2);
        ...
        if (localCursor1 != null)
        {
            ...
            do
            {
                ...
                if (localCursor2.moveToFirst())
                {
                    ...
                    startdest = localCursor2.getString(localCursor2.getColumnIndex("startst"));
                    startdest = startdest + "-" + localCursor2.getString(localCursor2.getColumnIndex("destst"));
                }
                if (localCursor2 != null) {
                    localCursor2.close();
                }
                ...
                if (localCursor3 != null)
                {
                    if (localCursor3.moveToFirst())
                    {
                        ...
                        localHashMap3.put("1", str1);
                        localHashMap3.put("2", str2);
                        localHashMap3.put("3", str3);
                        localHashMap3.put("4", speed);
                        localHashMap3.put("5", cars);
                        localHashMap3.put("6", startdest);
                        if (!Base.Fast_Trains_checkbox.equals("Yes")) {
                            break;
                        }
